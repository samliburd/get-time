...
function ffmpegCommand() {
    ...
    return ` ffmpeg -ss ${timeArr[0]} -to ${timeArr[1]} -i ${filename} -c:v libx264 -crf 17 -preset fast -ac 2 -c:a aac -map_metadata -1 -map_chapters -1 -movflags +faststart "${output}"`;
}
